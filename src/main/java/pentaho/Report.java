 ...
 * </ol>
 */
public class Report extends AbstractReportGenerator
{
  /**
...
//      final URL reportDefinitionURL = classloader.getResource("org/pentaho/reporting/engine/classic/samples/Sample1.prpt");
      ...
      final URL reportDefinitionURL = this.getClass().getClassLoader().getResource("reports/simple_report.prpt");
  ...
  public Map<String, Object> getReportParameters()
  {
    ...
    parameters.put("Report_Title", "Simple Embedded Report Example with Parameters");
    parameters.put("sub_title1", "sub_title1");
    parameters.put("sub_title2", "sub_title2");
...
//        });
  ...
  {
    String baseDir = "generated";

    // Create an output filename
    final File outputFilename = new File(baseDir, Report.class.getSimpleName() + ".pdf");

//    final URL reportPath = this.getClass().getClassLoader().getResource("reports/simple.prpt");


    // Generate the report
    new Report().generateReport(AbstractReportGenerator.OutputType.PDF, outputFilename);
